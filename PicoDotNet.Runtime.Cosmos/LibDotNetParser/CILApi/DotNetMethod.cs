...
public class DotNetMethod
{
    ...
    public List<MethodSignatureParam> Parms = new();
    ...
    public class MethodSignatureInfoV2
    {
        ...
        public List<MethodSignatureParam> Params = new();
        public bool IsStatic { get; set; }
        public string Signature { get; set; } = "";
        public int AmountOfParms { get; set; }
        public int AmountOfGenericParams { get; set; }
