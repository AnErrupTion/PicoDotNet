...
public class IlDecompiler
{
    ...
    private byte[] code;
    private List<DotNetFile> ContextTypes = new();
            ...
            case OpCodeOperandType.InlineField:
            {
                ...
                switch (f)
                {
                    ...
                    case 10:
                    {
                        ...
                        switch (type)
                        {
                            case MemberRefParentType.TypeSpec:
                            {
                                //Method spec
                            ...
                            case MemberRefParentType.TypeRef:
                            {
            ...
            case OpCodeOperandType.InlineMethod:
            {
                ...
                switch (f)
                {
                    ...
                    case 10:
                    {
                        ...
                        {
                            //TYPE def
                            case MemberRefParentType.TypeDef:
                            {
                            ...
                            //Module Ref
                            case MemberRefParentType.ModuleRef:
                            {
