...
public partial class DotNetClr
{
    ...
    {
        switch (m.Parent.FullName)
        {
            case "System.String" when obj.type == StackItemType.String:
            case "System.IntPtr" when obj.type == StackItemType.IntPtr:
            case "System.Byte" when obj.type == StackItemType.Int32:
            case "System.SByte" when obj.type == StackItemType.Int32:
            case "System.UInt16" when obj.type == StackItemType.Int32:
            case "System.Int16" when obj.type == StackItemType.Int32:
            case "System.UInt32" when obj.type == StackItemType.Int32:
            case "System.Int32" when obj.type == StackItemType.Int32:
            case "System.UInt64" when obj.type == StackItemType.Int64:
            case "System.Int64" when obj.type == StackItemType.Int64:
            case "System.Char" when obj.type == StackItemType.Int32:
            case "System.Object" when obj.type == StackItemType.Object:
            case "System.Type" when obj.type == StackItemType.Object:
            case "System.Boolean" when obj.type == StackItemType.Int32:
            case "System.Decimal" when obj.type == StackItemType.Object:
            case "System.Decimal" when obj.type == StackItemType.Decimal:
                return true;
            default:
                return false;
        }
...
{
    public static List<ArrayRef> ArrayRefs = new();
...
{
    public static List<ObjectRef> ObjectRefs = new();
    private static int CurrentIndex;
    public static int GetIndexFromRef(MethodArgStack r)
    {
        return (int)r.value;
